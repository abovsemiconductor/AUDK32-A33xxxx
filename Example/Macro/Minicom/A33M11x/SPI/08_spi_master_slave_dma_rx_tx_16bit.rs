...
# 1. Channel                   : 0 (SPI0)
#
# 2. Config                    : [ 0 i s 16 0 m h 23 -delay 1 1 1 ]
#    Operation                 : d (DMA)
#    Mode                      : s (Slave)
...
# 1. Channel                   : 1 (SPI1)
#
# 2. Config                    : [ 1 d m 16 0 m h 23 -delay 1 1 1 ]
#    Operation                 : d (DMA)
#    Mode                      : m (Master)
#    Data Length               : 16 (16bit)
#    Polarity/Phase            : 0 (Polarity : Low, Phase : Low)
...
send "config 0 d s 16 0 m h 23 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
...
send "config 1 d m 16 0 m h 23 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
