...
# 1. Channel                   : 0 (SPI0)
#
# 2. Config                    : [ 0 i s 9 0 m h 31 -delay 1 1 1 ]
...
# 1. Channel                   : 1 (SPI1)
#
# 2. Config                    : [ 1 i m 9 0 m h 31 -delay 1 1 1 ]
#    Operation                 : i (Interrupt)
#    Mode                      : m (Master)
#    Data Length               : 9 (9bit)
#    Polarity/Phase            : 0 (Polarity : Low, Phase : Low)
...
send "config 0 i s 9 0 m h 31 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
...
send "config 1 i m 9 0 m h 31 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
