...
# 1. Channel                   : 0 (SPI0)
#
# 2. Config                    : [ 0 n s 8 0 m h 5 -delay 1 1 1 ]
...
send "config 0 n s 8 0 m h 5 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
...
send "config 1 i m 8 0 m h 100 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
