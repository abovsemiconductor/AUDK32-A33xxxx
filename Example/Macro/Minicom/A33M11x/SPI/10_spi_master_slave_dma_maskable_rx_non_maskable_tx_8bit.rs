...
# 1. Channel                   : 0 (SPI0)
#
# 2. Config                    : [ 0 d s 8 0 m h 5 -delay 1 1 1 ]
#    Operation                 : d (DMA)
#    Mode                      : s (Slave)
#    Data Length               : 8 (8bit)
...
# 1. Channel                   : 1 (SPI1)
#
# 2. Config                    : [ 1 m m 8 0 m h 5 -delay 1 1 1 ]
#    Operation                 : m (Non Maskable Interrupt DMA)
#    Mode                      : m (Master)
#    Data Length               : 8 (8bit)
#    Polarity/Phase            : 0 (Polarity : Low, Phase : Low)
#    Bit Order                 : m (MSB)
...
#    Delay Burst               : 1
#
# 3. Data                      : [ 1 8 0xa5 0x5a 0xa5 0x5a 0xff 0x10 0x01 0x55 ]
#    Data Length               : 8
...
send "config 0 d s 8 0 m h 5 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
...
send "config 1 m m 8 0 m h 100 -delay 1 1 1"
expect {
    "<SPI> # "
    break
    timeout 5 goto end
