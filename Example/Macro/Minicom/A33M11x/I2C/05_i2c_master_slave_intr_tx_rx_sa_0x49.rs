...
#               : PC8 (Serial Data)
#    2. I2C1    : PF0 (Serial Clock)
#               : PF1 (Serial Data)
#
# E. Port Connection
#    1. PC7 (Serial Clock) <----> PF0 (Serial Clock)
#    2. PC8 (Serial Data)  <----> PF1 (Serial Data)
#
...
# 1. Channel                   : 1 (I2C0)
#
# 2. Config                    : [ 1 i s 400000 -saddr 0x49 ]
#    Operation                 : i (Interrupt)
#    Mode                      : s (Slave)
#    Baudrate                  : 400000 (400KHz)
#    Slave Address             : 0x49 (Hexa Format)
...
#
# 2. Port                      : [ 5 0 a 1 -pupd p ] [ 5 1 a 1 -pupd p]
#    Pin Number                : 0 / 1 
#    Pin Mode                  : a (Alternative)
...
send "config 1 i s 400000 -saddr 0x49"
expect {
    "<I2C> # "
    break
    timeout 5 goto end
