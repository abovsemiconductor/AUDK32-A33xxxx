# A. Description
#    A list of commands here configures AFE and generates evel high level detected interrupt.
#
# B. Preparation
...
#
# AFE0
# 1. Config                    : [ 0 i l h n 0 ]
#    Operation                 : i (Interrupt)
#    Mode                      : c (Comparator)
#      Trigger Mode            : l (Level)
#      Trigger Polarity        : h (High)
