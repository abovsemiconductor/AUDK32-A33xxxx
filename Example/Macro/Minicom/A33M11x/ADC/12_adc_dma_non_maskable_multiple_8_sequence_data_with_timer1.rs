# A. Description
#    A list of commands here configures ADC and generates non-maskable multiple capture interrupt 
#    based on DMA mode through timer1 trigger sources.
#
# B. Preparation
