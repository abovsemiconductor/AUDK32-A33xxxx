# A. Description
#    A list of commands here configures ADC and generates multiple capture interrupt based on DMA mode through mpwm0 trigger source.
#
# B. Preparation
