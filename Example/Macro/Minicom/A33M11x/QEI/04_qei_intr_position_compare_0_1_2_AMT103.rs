# A. Description
#    A list of commands here configures QEI module and generates position compare 0, 1, 2 interrupt.
#
# B. Preparation
...
#
# F. Note
#    Should execute the MPWM example script "15_mpwm_intr_normal_uvw_up_counter_bldc_cw_hall_sensor_IFX007T.ttl" at MPWM directory.
#
...
# 1. Channel                      : 0 (QEI0)
#
# 2. Config (cfg)                 : [ 0 i 0 q b m d 0xFFFFF ]
#    Operation                    : i (Interrupt)
#    Interrupt Enable             : 0 (N/A)
...
#
# 3. Compare Config (cmpcfg)      : [ 0 p 0 e 0x1000 ] [ 0 p 1 e 0x2000 ] [ 0 p 2 e 0x4000 ]
#    Counter Type                 : p (Position)
#    Compare Number               : 0 / 1 / 2
#    Interrupt Enable             : e (Enable)
#    Compare Value                : 0x1000 / 0x2000 / 0x4000
#
# PCU (PAx)
