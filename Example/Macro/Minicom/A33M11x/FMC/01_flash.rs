...
#
# 1. Code Flash Size : 0x20000(On REQ)/0x40000(MP)
#    0x40000 is taken as flash size to test
...
#    FMC_2KB_ERASE_MODE is taken to test code flash.
#    FMC_2KB_ERASE_MODE is taken to test data flash.
...
# Erase 16KB at CODE FLASH_SIZE
print "\n03.Erase 16KB code flash area at 0x3C000"
...
print "\n04.Dump memory (0x3C000 ~ 0x3FFFF)"
send "cm scu"
send "rmem 0x3C000 4096" 
expect {
    "<SCU> #"
    break
...
print "\n07.Write 32Byte data (0x00 ~ 0x1F) to code flash write protected area (0x3C000 ~ 0x3FFFF)"
send ""
expect {
    "<SCU> # "
    break
...
send "write 0 0x3C000 0xFFFFFFFF"
expect {
    "<FMC> # "
    break
    timeout 5 goto end
...
print "\n08.Dump memory (0x3C000 ~ 0x3FFFF)"
send "cm scu"
send "rmem 0x3C000 4096" 
expect {
    "<SCU> #"
