...
#               : PC5 (Receive)
#    2. UART2   : PB12 (Transmit)
#               : PB13 (Receive)
#
# E. Port Connection
#    1. PC6 (UART1 Transmit) <----> PB13 (UART2 Receive)
#    2. PC5 (UART1 Receive)  <----> PB12 (UART2 Transmit)
#
...
#
# 2. Port                      : [ 1 12 a 1 -pupd p ] [ 1 13 a 1 -pupd p ]
#    Pin Number                : 12 / 13
#    Pin Mode                  : a (Alternative)
#    Alternative               : 1 (TX/RX)
#    Pull-up/down              : p (Pull-up)
