# AUDK32 A33xxxx Series

AUDK32-A33xxxx is an SDK package for ABOV A33xxxx microcontroller series.  
...
```bash
git clone --recursive https://github.com/abovsemiconductor/AUDK32-A33xxxx.git
```
